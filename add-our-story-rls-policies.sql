-- ============================================================================
-- Add RLS Policies for Authenticated Users (Admin Access)
-- ============================================================================

-- Drop existing policies if needed to recreate them
DROP POLICY IF EXISTS "Authenticated users can insert our_story_hero" ON our_story_hero;
DROP POLICY IF EXISTS "Authenticated users can update our_story_hero" ON our_story_hero;
DROP POLICY IF EXISTS "Authenticated users can delete our_story_hero" ON our_story_hero;

DROP POLICY IF EXISTS "Authenticated users can insert our_story_content" ON our_story_content;
DROP POLICY IF EXISTS "Authenticated users can update our_story_content" ON our_story_content;
DROP POLICY IF EXISTS "Authenticated users can delete our_story_content" ON our_story_content;

DROP POLICY IF EXISTS "Authenticated users can insert our_story_values" ON our_story_values;
DROP POLICY IF EXISTS "Authenticated users can update our_story_values" ON our_story_values;
DROP POLICY IF EXISTS "Authenticated users can delete our_story_values" ON our_story_values;

DROP POLICY IF EXISTS "Authenticated users can insert our_story_timeline" ON our_story_timeline;
DROP POLICY IF EXISTS "Authenticated users can update our_story_timeline" ON our_story_timeline;
DROP POLICY IF EXISTS "Authenticated users can delete our_story_timeline" ON our_story_timeline;

DROP POLICY IF EXISTS "Authenticated users can insert our_story_team" ON our_story_team;
DROP POLICY IF EXISTS "Authenticated users can update our_story_team" ON our_story_team;
DROP POLICY IF EXISTS "Authenticated users can delete our_story_team" ON our_story_team;
DROP POLICY IF EXISTS "Authenticated users can read all team members" ON our_story_team;

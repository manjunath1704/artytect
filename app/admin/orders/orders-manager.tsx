            ...
            <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_320px]">
              ...
              <aside>
                ...
                <div className="mt-4 grid gap-3">
                  ...
                  <select disabled={updating} value={selected.order_status ?? "Payment Review"} onChange={(event) => updateOrder(selected, { order_status: event.target.value as OrderRow["order_status"] })} className="h-11 rounded-full border border-[#d9ccbc] px-4 text-sm">

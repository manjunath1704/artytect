...
const CategoryCardMicro = ({
  ...
  return (
    ...
    >
      <article className="relative h-full overflow-hidden rounded-[32px] shadow-sm bg-[#fffaf3] shadow-sm transition-shadow duration-300">
        <div className="relative overflow-hidden p-3 pb-0">
          <div className="relative aspect-[4/3] overflow-hidden rounded-[28px] bg-[#eee6dc]">
            ...
            <div className="absolute inset-x-5 bottom-5 text-white">
              {/* <p className="mb-3 text-[8px] font-semibold uppercase tracking-[0.24em] text-[#f1d8c2]">
                Explore collection
              </p> */}
              <h3 className="text-2xl font-display uppercase leading-none tracking-normal">
                {title}
              </h3>
            </div>
          </div>
...
export default CategoryCardMicro;
